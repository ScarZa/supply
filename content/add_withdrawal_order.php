                        ...
                        <div class="row">
                            <div class="col-lg-3 ol-xs-12">
                                ...
                                <select name="empno" id="empno" required  class="form-control select2" style="width: 100%;"  onkeydown="return nextbox(event, 'mate_name');">
                                    ...
                                    for ($i = 0; $i < count($result); $i++) {
                                        if ($result[$i]['empno'] == $edit[0]['empno']) {
                                            $selected = 'selected';
                                        } else {
                                            $selected = '';
                                        }
                            ...
                            <div class="col-lg-3 ol-xs-12">
                                ...
                                <select name="dep_id" id="dep_id" required  class="form-control select2" style="width: 100%;"  onkeydown="return nextbox(event, 'mate_name');">
                                    ...
                                    $mydata1->close_mysqli();
                                    for ($i = 0; $i < count($result); $i++) {
                                        if ($result[$i]['depId'] == $edit[0]['dep_id']) {
                                            $selected = 'selected';
                                        } else {
                                            $selected = '';
                                        }
                            ...
                            <div class="col-lg-3 ol-xs-12"> 
                                ...
                                <input value='<?php if (isset($method)) {
                                        echo $edit[0]['or_date'];
                                    } ?>' type="date" class="form-control" name="or_date" id="or_date" placeholder="วันที่" onkeydown="return nextbox(event, 'mate_unit')">
                            </div>
                            <div class="col-lg-3 ol-xs-12"> 
                                <label>ทะเบียนเอกสาร &nbsp;</label>
                                <input value="<?php if (isset($method)) {
                                        echo $edit[0]['order_amount'];
                                    } ?>" type="text" class="form-control" name="or_no" id="or_no" placeholder="เลขทะเบียนเอกสาร" onkeydown="return nextbox(event, 'min')">
                            </div></div>
                        <div class="row">
                            <div class="col-lg-3 ol-xs-12"> 
                                ...
                                <input value="<?php if (isset($method)) {
                                        echo $edit[0]['order_amount'];
                                    } ?>" type="text" class="form-control" name="withdrawal" id="withdrawal" placeholder="จำนวนรายการที่ขอเบิก" onkeydown="return nextbox(event, 'min')">
                            </div>
                        </div> 
                    </div>
                </div>

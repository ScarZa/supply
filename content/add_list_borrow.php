<section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="index.php?page=content/add_import_order"><i class="fa fa-edit"></i> ข้อมูลขอยืม</a></li>
              <li class="active"><i class="fa fa-edit"></i> แก้ไขข้อมูลขอเบิก</li>
              <?php }}else{?>
            <h1><img src='images/icon_set2/dolly.ico' width='40'><font color='blue'>  เพิ่มข้อมูลขอยืม </font></h1> 
            <ol class="breadcrumb">
              <li><a href="index.php"><i class="fa fa-home"></i> หน้าหลัก</a></li>
              <li class="active"><i class="fa fa-edit"></i> เพิ่มข้อมูลขอยืม</li>
              <?php }?>
            </ol>
        </section>
...
<?php
    ...
    ?><table border="0">
        <tr>
            <td>เลขทะเบียนเอกสาร : </td><td><u> <?= $detial_order[0]['bo_no']?></u></td>
        </tr>
        <tr>
        <td>วันที่บันทึก : </td><td><u> <?= DateThai2($detial_order[0]['bo_date'])?></u></td>
        </tr>
        <tr>
...
<!--<select name="mate_id[]" id="mate_id[]" required  class="form-control"  onkeydown="return nextbox(event, 'mate_name');">-->
   ...
   <input class="btn btn-warning" type="submit" name="submit" id="Submit" value="แก้ไข">
    <?php }}else{?> 
              <input type="hidden" name="method" id="method" value="add_list_borrow">
              <input type="hidden" name="id" id="id" value="<?= $bo_id?>">

...
bo.bo_status,m.mate_name,bw.amount,m.mate_unit,bo.bo_id
FROM se_borrow_order bo
INNER JOIN se_borrow bw ON bw.bo_id=bo.bo_id
INNER JOIN emppersonal e ON e.empno=bo.empno
INNER JOIN department d ON d.depId=bo.dep_id
INNER JOIN se_material m ON m.mate_id=bw.mate_id
WHERE bo.bo_id='$bo_id'
ORDER BY bw.borrow_id ASC";
    $myconn->db_m($sql);
              ...
              <div class="box box-success box-solid">
                ...
                <div class="box-body">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td colspan="3">เลขที่ทะเบียนยืม :&nbsp;<b><?= $result[0]['bo_no']?></b></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">วันที่ขอยืม :&nbsp;<b><?= DateThai2($result[0]['bo_date'])?></b></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">ผู้ขอยืม :&nbsp;<b><?= $result[0]['fullname']?></b></td>
                                    </tr>
                                    <tr>
